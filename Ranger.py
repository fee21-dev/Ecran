...
"""
img = Image.open(r"C:\Users\fnac\OneDrive\Bureau\cla.png")
img1 = Image.open(r"C:\Users\fnac\OneDrive\Bureau\logo.png")
iru = Image.open(r"C:\Users\fnac\OneDrive\Bureau\iru.png")
kak = Image.open(r"C:\Users\fnac\OneDrive\Bureau\kak.png")
asu = Image.open(r"C:\Users\fnac\OneDrive\Bureau\asu.png")
kur = Image.open(r"C:\Users\fnac\OneDrive\Bureau\kur.png")
gai = Image.open(r"C:\Users\fnac\OneDrive\Bureau\gai.png")
jir = Image.open(r"C:\Users\fnac\OneDrive\Bureau\jir.png")
img_og = Image.open(r"C:\Users\fnac\OneDrive\Bureau\par1.png")
...
#Importation d'une image ; modif taille + sauvegarde dans une variable (photo2)
...
#même chose pour une autre image (photo1)
...
#Création d'un bouton pour entrer dans l'écran de sélection des professeurs
...
#Ajout des images des professeurs sur le canva du panel1
Label(panel1,
...
def ouvrir_iruka():
    ...
    def valider_iruka():
        ...
        #Affichage du billet
        label = Label(billet, text=texte_billet, font=("Serif", 13), justify=LEFT, bg="#826D3F")
        label.pack(padx=20, pady=20, fill=BOTH, expand=True)
        
        #Bouton OK pour fermer le billet + la fenêtre principale
        boutton_ok = Button(billet, text="OK", command=lambda: [billet.destroy(), fen.destroy()])
...
def ouvrir_ka():
    ...
    def valider_kakashi():
        ...
        label = Label(billet, text=texte_billet, font=("Courier", 12), justify=LEFT, bg="#F0FFA4")
        label.pack(padx=20, pady=20, fill=BOTH, expand=True)
