...
def ouvrir_iruka():
    ...
    original_image = Image.open(r"C:\Users\fnac\OneDrive\Bureau\par1.png")
    ...
    bouton = Button(panel, text="Valider")
    ...
    def redraw(event=None):
        ...
        image = original_image.resize((win_width, win_height), Image.LANCZOS)
...
#Initialisation du module mixer de pygame pour la musique de fond
pygame.init()
